...
public class PoisonTrap : Trap
{
    ...
    {
        tickTimer = 0f;
        other.GetComponent<Player>().ChangePlayerSpeed(other.GetComponent<Player>().normalSpeed);
        other.GetComponent<Player>().ChangePlayerJumpPow(other.GetComponent<Player>().normalJumpPow);
    }
}
